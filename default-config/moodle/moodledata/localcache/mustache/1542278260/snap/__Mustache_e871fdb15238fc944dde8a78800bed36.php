...
class __Mustache_e871fdb15238fc944dde8a78800bed36 extends Mustache_Template
{
...
';
        $buffer .= $indent . '<ul id="snap-admin-tabs" class="nav nav-tabs col-sm-3" role="tablist">
';
        // 'tabs' section
        ...
        $buffer .= $indent . '</ul>
';
        $buffer .= $indent . '<div class="tab-content col-sm-9">
';
        // 'tabs' section
        $value = $context->find('tabs');
