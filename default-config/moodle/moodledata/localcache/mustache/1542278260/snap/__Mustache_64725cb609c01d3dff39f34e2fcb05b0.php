...
class __Mustache_64725cb609c01d3dff39f34e2fcb05b0 extends Mustache_Template
{
...
';
        ...
        $value = $this->resolveValue($context->find('badgesurl'), $context);
...
';
        ...
        $buffer .= call_user_func($this->mustache->getEscape(), $value);
        $buffer .= '" class="svg-icon" alt="" />Badges
';
        $buffer .= $indent . '    </a>
';
        $buffer .= $indent . '</div>
